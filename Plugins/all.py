...
☆""",
    ...
    if (
        ...
        if admin_pls(m.from_user.id, m.chat.id):
            return m.reply(
                "• أهلا بك في عالم الأوامر المتكاملة :\n━━━━━━━━━━━━━━━━\n◈ 「 م 𝟭 」 ↤︎ الحماية والقفل\n◈ 「 م 𝟮 」 ↤︎ التفعيل والتعطيل\n◈ 「 م 𝟯 」 ↤︎ الإدارة والضبط\n◈ 「 م 𝟰 」 ↤︎ التسلية والألعاب\n◈ 「 م 𝟱 」 ↤︎ المطورين والسودو\n━━━━━━━━━━━━━━━━\n◈ اختر ما تريده من الأزرار بالأسفل 🧚‍♀️",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "◈ م 𝟭 ◈", callback_data=f"commands1:{m.from_user.id}"
                            ),
                            InlineKeyboardButton(
                                "◈ م 𝟮 ◈", callback_data=f"commands2:{m.from_user.id}"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                                "◈ م 𝟯 ◈", callback_data=f"commands3:{m.from_user.id}"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                            ...
                            InlineKeyboardButton(
                                "◈ الألعاب ◈", callback_data=f"commands4:{m.from_user.id}"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            return m.reply(f"{k} عذراً، هذا القسم مخصص للطاقم الإداري فقط 🔒")
